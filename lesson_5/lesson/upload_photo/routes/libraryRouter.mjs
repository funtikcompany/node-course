...
router.post('/create',
    ...
    LibraryController.createLibrary); //create a new library module
router.get('/update/:id',
    LibraryController.getLibraryForm); //get the form to update a library module
router.get('/:id', LibraryController.getLibraryById) //get a library module by id


router.post('/update/:id',
    uploadMiddleWare.single('photo'),
    LibraryController.updateLibrary); //update a library module
