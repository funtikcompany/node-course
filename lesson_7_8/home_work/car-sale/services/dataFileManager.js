...
if (!settings.carsDataFilePath) {
  throw new Error('settings.carsDataFilePath is undefined')
}

export default new DataFileManager(settings.carsDataFilePath)
